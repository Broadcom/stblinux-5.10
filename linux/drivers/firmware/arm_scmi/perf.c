...
static int scmi_dvfs_num_domain_opps_get(const struct scmi_protocol_handle *ph,
...
static int scmi_dvfs_domain_freqs_get(const struct scmi_protocol_handle *ph,
