 ...
 * o If you add to this list, or the SRAM list below,
 *   be sure to enter the clock's name in the
 *   clk_names_stb[] array in
 *       drivers/soc/bcm/brcmstb/nexus/clk.c.
 */
...
#define BCLK_SW_MBVN		(BCLK_SW_OFFSET + 0x45)
