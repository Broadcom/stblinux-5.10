...
struct scmi_perf_proto_ops {
	...
	int (*device_opps_add)(const struct scmi_protocol_handle *ph,
			       struct device *dev);
	int (*num_domain_opps_get)(const struct scmi_protocol_handle *ph, u32 domain,
				   u32 *num_opps);
	...
	int (*domain_freqs_get)(const struct scmi_protocol_handle *ph,
				u32 domain, u32 *rates_khz);
};
